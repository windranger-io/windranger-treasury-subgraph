...
export const AUTHORIZER = Address.fromString('0x93ca6fa7d4b473ddc5e4506a26db225b6640bbbc');
...
export const FACTORY_OLD = Address.fromString('0x002c2275bef538f772f4a22f3d0649c1ca1420f0');
export const FACTORY_NEW = Address.fromString('0x9aaff2a100b1549728b7ccb74f9ef3158d333451');
export const BEACON = Address.fromString('0xbe42bbb1f26a943f849632325692b1f69496d65d');
export const IMPLEMENTATION = Address.fromString('0xb81bacddf7d99e85c2f98ce0be3317f96010dece');
